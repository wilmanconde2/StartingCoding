                ...
                if option == '1':                                 # menu de opciones escogido 1 - 7
                    ...
                    if len(matriz_coordinates) < 2:
                        ...
                        if election == '1':
                            ...
                            close_wifi.sort()
                            position1 = close_wifi[0]
                            users_spot1 = int(position1[-1][2])
                            distance1 = int(position1[0])
                            latitude1 = float(position1[-1][0])
                            longitude1 = float(position1[-1][1])
                            position2 = close_wifi[1]
                            users_spot2 = int(position2[-1][2])
                            distance2 = int(position2[0])
                            latitude2 = float(position2[-1][0])
                            longitude2 = float(position2[-1][1])
                            lathome = float(home[0])
                            lonhome = float(home[1])
                            
                            if users_spot1 < users_spot2:
                                print('La zona wifi 1: ubicada en' , position1[-1][0:2] , ' a ' , distance1 , ' metros, tiene en promedio ' , users_spot1 , ' usuarios\nLa zona wifi 2: ubicada en ' , position2[-1][0:2] , ' a ' , distance2 , ' metros, tiene en promedio ' , users_spot2 , ' usuarios')
                            elif users_spot1 > users_spot2:
                                print('La zona wifi 1: ubicada en' , position2[-1][0:2] ,' a ' , distance2 , ' metros, tiene en promedio ' , users_spot2 , ' usuarios\nLa zona wifi 2: ubicada en ' , position1[-1][0:2] , ' a ' , distance1 , ' metros, tiene en promedio ' , users_spot1 , ' usuarios')
